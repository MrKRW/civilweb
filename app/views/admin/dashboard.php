...
<body>
  ...
  <aside id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="#" class="nav-item" data-page="blog-posts">
      ...
      <a href="#" class="nav-item" data-page="add-blog-post">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
  ...
  <main id="main-content">
    ...
    <section id="page-dashboard" class="page active">
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-info">
            <span class="stat-number" id="stat-blog">—</span>
    ...
    <!-- ── BLOG POSTS PAGE ───────────────────────── -->
    <section id="page-blog-posts" class="page">
      <div class="page-header">
        <h1>Blog Posts</h1>
        <div class="page-actions">
          <select id="filter-blog-status" class="filter-select">
            <option value="">All Status</option>
            <option value="published">Published</option>
            <option value="draft">Draft</option>
          </select>
          <button class="btn-primary" onclick="navigateTo('add-blog-post')">+ Add Blog Post</button>
        </div>
      </div>
      <div class="card">
        <div id="blog-posts-table" class="table-wrap">
          <p class="loading-text">Loading…</p>
        </div>
      </div>
    </section>
    ...
    <section id="page-add-blog-post" class="page">
      <div class="page-header">
        <h1 id="blog-form-page-title">Add New Blog Post</h1>
        <p class="page-subtitle">Fill in the blog post details below</p>
      </div>

      <div class="card">
        <form id="blog-form" enctype="multipart/form-data">
          <input type="hidden" id="blog-edit-id" name="id" value="" />

          <div class="form-grid">

            <!-- Title -->
            <div class="form-group full-width">
              <label for="blog-title">Post Title <span class="req">*</span></label>
              <input type="text" id="blog-title" name="title" required placeholder="Enter post title" />
            </div>

            <!-- Category -->
            <div class="form-group">
              <label for="blog-category">Category</label>
              <input type="text" id="blog-category" name="category" placeholder="e.g. Architecture" />
            </div>
            ...
            <!-- Sort Order -->
            <div class="form-group">
              <label for="blog-sort">Sort Order</label>
              <input type="number" id="blog-sort" name="sort_order" value="0" min="0" />
            </div>

            <!-- Excerpt -->
            <div class="form-group full-width">
              <label for="blog-excerpt">Excerpt <small style="font-weight:400;color:var(--text-muted)">(short summary shown on blog page)</small></label>
              <textarea id="blog-excerpt" name="excerpt" rows="3" placeholder="A brief summary of the post…"></textarea>
            </div>
            ...
            <div class="form-group full-width">
              ...
              <div class="upload-zone" id="blog-upload-zone">
                <input type="file" id="blog-image" name="image" accept="image/*" class="upload-input" />
                <div class="upload-placeholder" id="blog-upload-placeholder">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>
                  <span>Click or drag to upload cover image</span>
                  <small>JPEG, PNG, WebP — max 10 MB</small>
                </div>
                <div class="upload-preview" id="blog-upload-preview" style="display:none;">
                  <img id="blog-preview-img" src="" alt="Preview" />
                  <button type="button" class="upload-remove" onclick="removeBlogImage()">×</button>
                </div>
              </div>
            </div>
          ...
          <div class="form-actions">
            <button type="button" class="btn-ghost" onclick="resetBlogForm()">Cancel</button>
            <button type="submit" class="btn-primary" id="blog-form-submit-btn">
              <span>Save Post</span>
            </button>
          </div>
        </form>
